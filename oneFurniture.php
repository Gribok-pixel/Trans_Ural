...
<div class="container">
        ...
        <div class="col one-furniture-image">
            <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff" class="swiper mySwiper2">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <img src="<?= "../" . $item['image_two']; ?>" />
                    </div>
                    <div class="swiper-slide">
                        <img src="<?= "../" . $item['image_three']; ?>" />
                    </div>
                </div>
        ...
        <div class="col-xl-5">
            ...
            <div class="one-furniture-card">
                ...
                <div class="one-furniture-card-top">
                    ...
                    <div class="installment-payment">В рассрочку от<span>7 000 &#8381;/мес.</span></div>
    ...
    <div class="modal-furniture-order">
        <form method="POST" action="furnitureOrder.php">
            ...
            <div class="mb-3">
                <input type="hidden" value="<?=$item['id']?>" name="furniture_id">
            </div>
            <div class="mb-3">
                <input type="hidden" value="<?=$item['name']?>" name="furniture_name">
            </div>
